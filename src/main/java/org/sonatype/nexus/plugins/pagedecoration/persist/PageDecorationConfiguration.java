...
public interface PageDecorationConfiguration
{
  Configuration getConfiguration();
  Configuration getDefaultConfiguration();
  void save();

  PageDecorationConfigDTO readPageDecorationConfig();
  void updatePageDecorationConfig(PageDecorationConfigDTO pageDecorationConfig) throws InvalidConfigurationException;
}
